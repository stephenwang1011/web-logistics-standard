 ...
 * */
public class UserPasswordUnattestedFather extends BaseParpare {
	protected static int timeOut = 0;
	protected static int sleepTime = 0;
	protected static String modifyusername1 = "";
	protected static String modifypassword1= "";
	...
	public static void userPasswordParpare(ITestContext context, SeleniumUtil seleniumUtil) {
		...
		modifyusername1 = PropertiesDataProvider.getTestData(configFilePath, "modifyusername1");
		modifypassword1 = PropertiesDataProvider.getTestData(configFilePath, "modifypassword1");
	
		HomePageHelper.waitHomePageToLoad(timeOut, seleniumUtil);
		HomePageHelper.enterPage(seleniumUtil, HomePage.HP_BUTTON_LOGIN);
		LoginPageHelper.login(seleniumUtil, modifyusername1,modifypassword1);
