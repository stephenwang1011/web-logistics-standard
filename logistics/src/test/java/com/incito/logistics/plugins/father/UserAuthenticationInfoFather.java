...
public class UserAuthenticationInfoFather extends BaseParpare {
	...
	public static void userAuthenticationInfoParpare(ITestContext context, SeleniumUtil seleniumUtil) {
		...
		By[] bys = { AddUserInfoPage.AUIP_INPUT_NAME, AddUserInfoPage.AUIP_INPUT_TEL, AddUserInfoPage.AUIP_INPUT_PHOTO, AddUserInfoPage.AUIP_INPUT_CHIT, AddUserInfoPage.AUIP_INPUT_COMPANY, AddUserInfoPage.AUIP_INPUT_IDCARD, AddUserInfoPage.AUIP_INPUT_ADDRESS };
