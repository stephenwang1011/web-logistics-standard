 ...
 * */
public class SendGoodsPage_520_Enterprise_BeyondWeightFailFromPlatform_Test extends BaseParpare {

	@Test(dataProvider = "data")
	public void sendBeyondWeightFailFromPlatform(ITestContext context, Map<String, String> data) {
