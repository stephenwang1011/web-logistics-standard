...
public class MyOrdersPage_704_Enterprise_PulicCarsOrders_SendToAndSendTo_Test extends BaseParpare {
	@Test(dataProvider = "data")
	public void SendToAndSendTo(ITestContext context, Map<String, String> data) {
		...
		MyOrdersPageHelper.enterPage(seleniumUtil, MyOrdersPage.MOP_TAB_SOCIETYCARS);
		MyOrdersPageHelper.waitForMyOrdersPageToLoad(seleniumUtil, timeOut);
		...
		MyOrdersPageHelper.waitForMyOrdersPageToLoad(seleniumUtil, timeOut);
		MyOrdersPageHelper.checkMyOrdersAddress(seleniumUtil, MyOrdersPage.MOP_EP_TEXT_ORDERSINFOES,  MyOrdersPage.MOP_TEXT_ADDRESS,
				data.get("MOP_INPUT_SENDFROMCITY"), data.get("MOP_INPUT_SENDTOCITY"));
	}
