 ...
 *
 * */
public class AddUserInfoPage_27_Fail_IdcardCompanyAddress_Test extends BaseParpare {
	@Test
	public void addUserInfoPageFailIdcardCompanyAddress(ITestContext context) {
		...
		AddUserInfoPagerHelper.checkAddUserInfoPrompt_IdcardCompanyAddress(timeOut, seleniumUtil);
	}
