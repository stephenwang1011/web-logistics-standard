...
/**
 * @author xy-incito-wk
 * @Description 未认证的用户，进入我的资料-基本信息模块,修改生日qq和电子邮件并检测是不是修改成功
 *
 * */
public class UserBaseInfoPage_017_Unattested_BirthdayQQEmail_Test extends UserBaseInfoUnattestedFather {
	@Test(dataProvider = "data")
	public void modifyBirthQQAndEmailForUnattestedUser(ITestContext context, Map<String, String> data) {
