...
/**
 * @author xy-incito-wy
 * @Description 测试用例：发布货源，件数超过100件
 * */
public class SendGoodsPage_022_Beyond_Count_Fail_Test extends BaseParpare {

	@Test(dataProvider = "data")
	public void sendBeyondCountFailTest(ITestContext context, Map<String, String> data) {
