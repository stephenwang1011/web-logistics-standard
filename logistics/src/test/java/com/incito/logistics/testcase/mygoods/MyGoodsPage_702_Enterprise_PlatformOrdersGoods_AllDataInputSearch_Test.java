 ...
 * */
public class MyGoodsPage_702_Enterprise_PlatformOrdersGoods_AllDataInputSearch_Test extends BaseParpare {
	...
	public void allDataInputSearch(ITestContext context, Map<String, String> data) {
		...
		MyGoodsPageHelper.typeGoodsInfo(seleniumUtil, 
				data.get("MGP_INPUT_GOODSNO"),data.get("MGP_INPUT_ORIGINALCITY"),
				data.get("MGP_INPUT_TARGETCITY"),data.get("MGP_INPUT_GOODSNAME"),
				data.get("MGP_WEIGHT_VOLUME"),data.get("MGP_START_WEIGHT_VOLUME"),
				data.get("MGP_END_WEIGHT_VOLUME"),data.get("MGP_INPUT_STARTDATE"),
				data.get("MGP_INPUT_ENDDATE"));
		MyGoodsPageHelper.checkGoodsAddress(seleniumUtil, MyGoodsPage.MGP_SPAN_ADDRESS, 
