 ...
 * */
public class FindCarsPage_517_Enterprise_CancelFavoriteCars_Test extends BaseParpare {

	@Test(dataProvider = "data")
	public void cancelFavoriteCarsInPublicForEnterprise(ITestContext context, Map<String, String> data) {
