 ...
 *
 * */
public class UserAttestedInfoPage_308_UnattestedReject_Address_Test extends UserAttestedInfoAttestRejectFather {
	@Test(dataProvider = "data")
	public void userAttestedInfoPageUnattestedRejectAddressTest(ITestContext context, Map<String, String> data) {
