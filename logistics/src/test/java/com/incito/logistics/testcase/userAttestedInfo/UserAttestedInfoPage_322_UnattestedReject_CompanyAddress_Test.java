 ...
 *
 * */
public class UserAttestedInfoPage_322_UnattestedReject_CompanyAddress_Test extends UserAttestedInfoAttestRejectFather {
	@Test(dataProvider = "data")
	public void userAttestedInfoPageUnattestedRejectCompanyAddressTest(ITestContext context, Map<String, String> data) {
