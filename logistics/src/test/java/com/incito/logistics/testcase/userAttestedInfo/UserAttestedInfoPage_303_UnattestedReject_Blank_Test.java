 ...
 *
 * */
public class UserAttestedInfoPage_303_UnattestedReject_Blank_Test extends UserAttestedInfoAttestRejectFather {
	@Test(dataProvider = "data")
	public void userAttestedInfoPageUnattestedRejectBlankTest(ITestContext context, Map<String, String> data) {
