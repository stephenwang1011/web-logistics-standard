 ...
 * 
 * @author xy-incito-wy
 * @Decription 认证驳回的用户登录之后，进入修改密码页面，输入错误的当前密码，新密码为空,确认密码不为空，点击提交按钮，不能修改提交成功
 */
public class UserPasswordPage_305_AttestRejectIncorrectOldPasswdNewEmpty_Test extends UserPasswordAttestRejectFather{
	
	@Test(dataProvider="data")
	public void incorrectOldPasswdNewEmptyForAttestRejectUser(ITestContext context,Map<String,String> data){
