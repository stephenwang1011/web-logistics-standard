...
/**
 * @author xy-incito-wk
 * @Description 认证中的用户，进入我的资料-基本信息模块,修改qq和头像并检测是不是修改成功
 *
 * */
public class UserBaseInfoPage_109_Attesting_PhotoQQ_Test extends UserBaseInfoAttestingFather {
	@Test(dataProvider = "data")
	public void modifyQQAndPhotoForAttestingUser(ITestContext context, Map<String, String> data) {
