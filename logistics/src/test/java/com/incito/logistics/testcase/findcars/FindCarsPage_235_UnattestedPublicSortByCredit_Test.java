...
/**
 * @author xy-incito-wy
 * @Description 未认证用户，进入找车源-公共车源中，按照信用等级排序车源
 * */
public class FindCarsPage_235_UnattestedPublicSortByCredit_Test extends FindCarsUnattestedFather {

	@Test
	public void unattestedPublicSortByCredit(ITestContext context) {
