 ...
 * 
 * @author xy-incito-wk
 * @Description 测试用例：已登录的情况下，未认证的用户登录，点击我的收藏，找货源模块下，公共货源上的按照重量排序
 */
public class FindGoodsPagePrivateGoods_119_UnattestedUserCarWeightSort_Test extends FindGoodsUnatestedFather {
	@Test
	public void unattestedUserCarWeightSort(ITestContext context) {
