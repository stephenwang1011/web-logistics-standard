 ...
 *
 * */
public class AddUserInfoPage_030_Fail_NameTelCompanyAddress_Test extends BaseParpare {
	...
	public void addUserInfoPageFailNameTelCompanyAddress(ITestContext context, Map<String, String> data) {
		...
		seleniumUtil.type(seleniumUtil.findElementBy(AddUserInfoPage.AUIP_INPUT_COMPANY), data.get("ADD_OMPANY"));
