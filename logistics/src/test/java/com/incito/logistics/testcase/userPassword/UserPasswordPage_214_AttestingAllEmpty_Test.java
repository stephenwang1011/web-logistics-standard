 ...
 */
public class UserPasswordPage_214_AttestingAllEmpty_Test extends UserPasswordAttestingFather{
	
	@Test(dataProvider="data")
	public void allEmptyForAttestingUser(ITestContext context,Map<String,String> data){
