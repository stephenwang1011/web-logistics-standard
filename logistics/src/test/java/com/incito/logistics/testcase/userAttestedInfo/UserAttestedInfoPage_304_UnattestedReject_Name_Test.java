 ...
 *
 * */
public class UserAttestedInfoPage_304_UnattestedReject_Name_Test extends UserAttestedInfoAttestRejectFather {
	@Test(dataProvider = "data")
	public void userAttestedInfoPageUnattestedRejectNameTest(ITestContext context, Map<String, String> data) {
