 ...
 * */
public class SendGoodsPage_511_Enterprise_WeightEmptyDataFailToPlatform_Test extends BaseParpare {

	@Test(dataProvider="data")
	public void sendWeightEmptyDataToPlatformFailTest(ITestContext context,Map<String, String> data) {
