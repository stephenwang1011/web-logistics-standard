 ...
 * */
public class FindCarsPage_009_EndCarWeightDataInputSearch_Test extends BaseParpare {
	...
	public void endCarWeightDataInputSearch(ITestContext context, Map<String, String> data) {
		...
		FindCarsPagerHelper.checkCarWeight(seleniumUtil, data.get("FCP_INPUT_STARTWEIGHT"),data.get("FCP_INPUT_ENDWEIGHT"));
