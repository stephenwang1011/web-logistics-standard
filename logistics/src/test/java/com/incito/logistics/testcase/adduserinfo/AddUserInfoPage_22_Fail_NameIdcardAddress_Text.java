 ...
 *
 * */
public class AddUserInfoPage_22_Fail_NameIdcardAddress_Text extends BaseParpare {
	@Test
	public void addUserInfoPageFailNameIdcardAddress(ITestContext context) {
		...
		AddUserInfoPagerHelper.checkAddUserInfoPrompt_NameIdcardAddress(timeOut, seleniumUtil);
	}
