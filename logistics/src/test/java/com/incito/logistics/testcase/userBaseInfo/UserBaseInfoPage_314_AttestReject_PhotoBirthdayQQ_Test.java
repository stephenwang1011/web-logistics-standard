...
/**
 * @author xy-incito-wk
 * @Description 认证驳回的用户，进入我的资料-基本信息模块,修改头像和生日以及qq并检测是不是修改成功
 *
 * */
public class UserBaseInfoPage_314_AttestReject_PhotoBirthdayQQ_Test extends UserBaseInfoAttestRejectFather {
	@Test(dataProvider = "data")
	public void modifyPhotoBirthdayQQForAttestRejectUser(ITestContext context, Map<String, String> data) {
