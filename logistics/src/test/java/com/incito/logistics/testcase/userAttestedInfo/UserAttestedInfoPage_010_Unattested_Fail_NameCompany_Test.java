...
/**
 * @author xy-incito-wk
 * @Description 认证信息界面，未认证用户，填写信息姓名和公司名称提交
 *
 * */
public class UserAttestedInfoPage_010_Unattested_Fail_NameCompany_Test extends UserAttestedInfoUnattestedFather {
	@Test(dataProvider = "data")
	public void UserAttestedInfoPageUnattestedFailNameCompanyTest(ITestContext context, Map<String, String> data) {
