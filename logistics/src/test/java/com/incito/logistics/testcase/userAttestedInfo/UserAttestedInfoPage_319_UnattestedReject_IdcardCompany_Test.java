 ...
 *
 * */
public class UserAttestedInfoPage_319_UnattestedReject_IdcardCompany_Test extends UserAttestedInfoAttestRejectFather {
	@Test(dataProvider = "data")
	public void userAttestedInfoPageUnattestedRejectIdcardCompanyTest(ITestContext context, Map<String, String> data) {
