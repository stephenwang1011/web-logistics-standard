...
/**
 * @author xy-incito-wy
 * @Description  未认证用户，进入找车源-我的收藏中，按照信用等级排序车源
 * */
public class FindCarsPage_240_UnattestedPrivateSortByCredit_Test extends FindCarsUnattestedFather {

	@Test
	public void UnattestedPrivateSortByCredit(ITestContext context) {
