 ...
 * 
 * @author xy-incito-wk
 * @Description 测试用例：已登录的情况下，未认证的用户登录，点击公共货源，在搜索条件下选择体积输入最小体积，检查搜索结果
 */
public class FindGoodsPagePublicGoods_113_UnattestedUserMinVolumeData_Test extends FindGoodsUnatestedFather {
