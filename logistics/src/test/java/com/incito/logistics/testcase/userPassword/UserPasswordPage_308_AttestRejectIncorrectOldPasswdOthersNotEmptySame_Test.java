 ...
 */
public class UserPasswordPage_308_AttestRejectIncorrectOldPasswdOthersNotEmptySame_Test extends UserPasswordAttestRejectFather{
	
	@Test(dataProvider="data")
	public void incorrectOldPasswdOthersNotEmptySameForAttestRejectUser(ITestContext context,Map<String,String> data){
