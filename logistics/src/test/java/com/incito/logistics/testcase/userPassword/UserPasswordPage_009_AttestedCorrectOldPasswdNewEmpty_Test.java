 ...
 */
public class UserPasswordPage_009_AttestedCorrectOldPasswdNewEmpty_Test extends UserPasswordAttestedFather{
	
	@Test(dataProvider="data")
	public void correctOldPasswdNewEmptyForAttestedUser(ITestContext context,Map<String,String> data){
