 ...
 * */
public class FindCarsPage_014_TargetCityDataInputSearch_Test extends BaseParpare {
	...
	public void targetCityDataInputSearch(ITestContext context, Map<String, String> data) {
		...
		FindCarsPagerHelper.checkTargetCity(seleniumUtil,data.get("FCP_INPUT_TO"));
