 ...
 * */
public class MyGoodsPage_017_DeleteGoods_Test extends MyGoodsFather {
	...
	public void deleteGoodsAgain(ITestContext context, Map<String, String> data) {
		...
		MyGoodsPageHelper.deleteTargetGoods(seleniumUtil, data.get("INSTRUCTION"),true);
		MyGoodsPageHelper.checkGoodsExistAfterDelete(seleniumUtil, data.get("INSTRUCTION"),true);
