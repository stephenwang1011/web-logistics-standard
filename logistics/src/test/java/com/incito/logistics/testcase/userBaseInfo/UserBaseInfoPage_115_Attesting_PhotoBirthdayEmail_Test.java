...
/**
 * @author xy-incito-wk
 * @Description 认证中的用户，进入我的资料-基本信息模块,修改头像生日和电子邮件并检测是不是修改成功
 *
 * */
public class UserBaseInfoPage_115_Attesting_PhotoBirthdayEmail_Test extends UserBaseInfoAttestingFather {
	@Test(dataProvider = "data")
	public void modifyPhotoBirthAndEmailForAttestingUser(ITestContext context, Map<String, String> data) {
