...
/**
 * @author xy-incito-wk
 * @Description 认证驳回的用户，进入我的资料-基本信息模块,修改：生日、QQ、Email并检测是不是修改成功
 *
 * */
public class UserBaseInfoPage_317_AttestReject_BirthdayQQEmail_Test extends UserBaseInfoAttestRejectFather {
	@Test(dataProvider = "data")
	public void modifyBirthdayQQEmailForAttestRejectUser(ITestContext context, Map<String, String> data) {
