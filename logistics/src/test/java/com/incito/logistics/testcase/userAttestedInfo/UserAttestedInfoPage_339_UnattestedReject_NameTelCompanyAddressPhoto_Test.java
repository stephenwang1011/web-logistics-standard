 ...
 *
 * */
public class UserAttestedInfoPage_339_UnattestedReject_NameTelCompanyAddressPhoto_Test extends UserAttestedInfoAttestRejectFather {
	@Test(dataProvider = "data")
	public void userAttestedInfoPageUnattestedRejectNameTelCompanyAddressPhotoTest(ITestContext context, Map<String, String> data) {
