...
/**
 * @author xy-incito-wy
 * @Description 企业账户下 找车源，只输入车长：开始车重 进行搜索
 * */
public class FindCarsPage_508_Enterprise_PublicStartCarWeightDataInputSearch_Test extends BaseParpare {

	@Test(dataProvider = "data")
	public void publicStartCarWeightDataInputSearchForEnterprise(ITestContext context, Map<String, String> data) {
