 ...
 * */
public class FindCarsPage_515_Enterprise_FavoriteCarsWithNoSearch_Test extends BaseParpare {

	@Test(dataProvider = "data")
	public void favoriteCarsWithNoSearchForEnterprise(ITestContext context,Map<String,String> data) {
