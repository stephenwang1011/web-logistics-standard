...
/**
 * @author xy-incito-wy
 * @Description 货代A发布一条声明价值公开的货源，货代B登陆之后去找货源处检查此货源声明价值可以看到
 * */
public class SendGoodsPage_044_AttestedSendPublicDeclareValue_Test extends SendGoodsFather {

	@Test(dataProvider = "data")
	public void attestedSendPublicDeclareValue(ITestContext context, Map<String, String> data) {
		...
		SendGoodsPageHelper.doesCheckDeclareValue(seleniumUtil, "YES");
		...
		SendGoodsPageHelper.checkDeclareValueInGoods(seleniumUtil, "public", data.get("SGP_INPUT_DECLAREVALUE"), data.get("AGENT"), data.get("PASSWD"), timeOut);
