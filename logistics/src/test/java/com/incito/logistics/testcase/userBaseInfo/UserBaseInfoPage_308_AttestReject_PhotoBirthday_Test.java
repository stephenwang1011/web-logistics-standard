...
/**
 * @author xy-incito-wk
 * @Description 认证、驳回的用户，进入我的资料-基本信息模块，修改头像和生日并检测是不是修改成功
 *
 * */
public class UserBaseInfoPage_308_AttestReject_PhotoBirthday_Test extends UserBaseInfoAttestRejectFather {
	@Test(dataProvider = "data")
	public void modifyPhotoBirthForAttestRejectUser(ITestContext context, Map<String, String> data) {
