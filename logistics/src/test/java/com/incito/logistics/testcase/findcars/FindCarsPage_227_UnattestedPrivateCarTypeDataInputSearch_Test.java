...
/**
 * @author xy-incito-wy
 * @Description 未认证用户，在找车源-我的收藏模块中，输入车型检索条件，可以准确查出正确的数据
 * */
public class FindCarsPage_227_UnattestedPrivateCarTypeDataInputSearch_Test extends FindCarsUnattestedFather {

	@Test(dataProvider = "data")
	public void unattestedPrivateCarTypeDataInputSearch(ITestContext context, Map<String, String> data) {
