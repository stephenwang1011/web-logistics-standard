...
/**
 * @author xy-incito-wk
 * @Description 未认证的用户，进入我的资料-基本信息模块,修改头像 qq和地址并检测是不是修改成功
 *
 * */
public class UserBaseInfoPage_016_Unattested_PhotoQQEmail_Test extends UserBaseInfoUnattestedFather {
	@Test(dataProvider = "data")
	public void modifyPhotoQQAndEmailForUnattestedUser(ITestContext context, Map<String, String> data) {
