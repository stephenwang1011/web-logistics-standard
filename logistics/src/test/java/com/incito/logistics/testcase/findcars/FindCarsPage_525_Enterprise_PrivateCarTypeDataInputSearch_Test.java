 ...
 * */
public class FindCarsPage_525_Enterprise_PrivateCarTypeDataInputSearch_Test extends BaseParpare {

	@Test(dataProvider = "data")
	public void privateCarsTypeDataInputSearchForEnterprise(ITestContext context, Map<String, String> data) {
