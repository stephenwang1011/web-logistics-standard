 ...
 *
 * */
public class AddUserInfoPage_11_Fail_NameAddress_Test extends BaseParpare {
	@Test
	public void addUserInfoPageFailNameAddress(ITestContext context) {
		...
		AddUserInfoPagerHelper.checkAddUserInfoPrompt_NameAdress(timeOut, seleniumUtil);
