 ...
 *
 * */
public class UserAttestedInfoPage_338_UnattestedReject_NameTelIdcardAddressPhoto_Test extends UserAttestedInfoAttestRejectFather {
	@Test(dataProvider = "data")
	public void userAttestedInfoPageUnattestedRejectNameTelIdcardAddressPhotoTest(ITestContext context, Map<String, String> data) {
