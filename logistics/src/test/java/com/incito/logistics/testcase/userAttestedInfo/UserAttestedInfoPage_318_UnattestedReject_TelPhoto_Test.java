 ...
 *
 * */
public class UserAttestedInfoPage_318_UnattestedReject_TelPhoto_Test extends UserAttestedInfoAttestRejectFather {
	@Test(dataProvider = "data")
	public void userAttestedInfoPageUnattestedRejectTelPhotoTest(ITestContext context, Map<String, String> data) {
