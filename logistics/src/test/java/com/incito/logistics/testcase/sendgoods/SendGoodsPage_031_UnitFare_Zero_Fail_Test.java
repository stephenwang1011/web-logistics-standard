...
/**
 * @author xy-incito-wy
 * @Description 测试用例：发布货源，单价0元
 * */
public class SendGoodsPage_031_UnitFare_Zero_Fail_Test extends SendGoodsFather {

	@Test(dataProvider = "data")
	public void sendFareZeroFailTest(ITestContext context, Map<String, String> data) {
