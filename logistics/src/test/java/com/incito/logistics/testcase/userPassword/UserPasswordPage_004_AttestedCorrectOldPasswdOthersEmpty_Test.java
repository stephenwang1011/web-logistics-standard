 ...
 */
public class UserPasswordPage_004_AttestedCorrectOldPasswdOthersEmpty_Test extends UserPasswordAttestedFather{
	
	@Test(dataProvider="data")
	public void correctOldPasswdOthersEmptyForAttestedUser(ITestContext context,Map<String,String> data){
