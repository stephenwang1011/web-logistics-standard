...
/**
 * @author xy-incito-wk
 * @Description 认证驳回的用户，进入我的资料-基本信息模块，修改生日和qq并检测是不是修改成功
 *
 * */
public class UserBaseInfoPage_311_AttestReject_BirthdayQQ_Test extends UserBaseInfoAttestRejectFather {
	@Test(dataProvider = "data")
	public void modifyQQBirthForAttestRejectUser(ITestContext context, Map<String, String> data) {
