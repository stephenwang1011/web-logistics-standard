 ...
 *
 * */
public class UserAttestedInfoPage_316_UnattestedReject_TelCompany_Test extends UserAttestedInfoAttestRejectFather {
	@Test(dataProvider = "data")
	public void userAttestedInfoPageUnattestedRejectTelCompanyTest(ITestContext context, Map<String, String> data) {
