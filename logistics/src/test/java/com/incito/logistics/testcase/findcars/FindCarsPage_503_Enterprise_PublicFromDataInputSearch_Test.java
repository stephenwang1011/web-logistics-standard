...
/**
 * @author xy-incito-wy
 * @Description 企业账户下的 找车源，只输入出发地进行搜索
 * */
public class FindCarsPage_503_Enterprise_PublicFromDataInputSearch_Test extends BaseParpare {

	@Test(dataProvider = "data")
	public void publicFromDataInputSearchForEnterprise(ITestContext context, Map<String, String> data) {
