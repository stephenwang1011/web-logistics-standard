 ...
 *
 * */
public class UserAttestedInfoPage_335_UnattestedReject_CompanyAddressPhoto_Test extends UserAttestedInfoAttestRejectFather {
	@Test(dataProvider = "data")
	public void userAttestedInfoPageUnattestedRejectCompanyAddressPhotoTest(ITestContext context, Map<String, String> data) {
