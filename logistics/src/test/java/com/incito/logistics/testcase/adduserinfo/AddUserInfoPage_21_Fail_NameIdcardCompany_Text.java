 ...
 *
 * */
public class AddUserInfoPage_21_Fail_NameIdcardCompany_Text extends BaseParpare {
	@Test
	public void addUserInfoPageFailNameIdcardCompany(ITestContext context) {
		...
		AddUserInfoPagerHelper.checkAddUserInfoPrompt_NameIdcardCompany(timeOut, seleniumUtil);
	}
