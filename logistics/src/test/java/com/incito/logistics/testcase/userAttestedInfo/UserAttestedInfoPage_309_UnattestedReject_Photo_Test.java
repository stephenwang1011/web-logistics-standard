 ...
 *
 * */
public class UserAttestedInfoPage_309_UnattestedReject_Photo_Test extends UserAttestedInfoAttestRejectFather {
	@Test(dataProvider = "data")
	public void userAttestedInfoPageUnattestedRejectPhotoTest(ITestContext context, Map<String, String> data) {
