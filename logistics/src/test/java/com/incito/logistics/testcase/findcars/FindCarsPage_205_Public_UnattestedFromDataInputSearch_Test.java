...
/**
 * @author xy-incito-wy
 * @Description 未认证的用户，在找车源页面进行检索操作：只输入车辆出发地，点击查询按钮之后 未认证用户会得到查询列表并且结果正确（有权限）
 * */
public class FindCarsPage_205_Public_UnattestedFromDataInputSearch_Test extends FindCarsUnattestedFather {

	@Test(dataProvider = "data")
	public void publicUnattestedFromDataInputSearch(ITestContext context, Map<String, String> data) {
