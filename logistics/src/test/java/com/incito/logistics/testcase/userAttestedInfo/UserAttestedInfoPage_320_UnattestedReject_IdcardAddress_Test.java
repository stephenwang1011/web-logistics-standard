 ...
 *
 * */
public class UserAttestedInfoPage_320_UnattestedReject_IdcardAddress_Test extends UserAttestedInfoAttestRejectFather {
	@Test(dataProvider = "data")
	public void userAttestedInfoPageUnattestedRejectIdcardAddressTest(ITestContext context, Map<String, String> data) {
