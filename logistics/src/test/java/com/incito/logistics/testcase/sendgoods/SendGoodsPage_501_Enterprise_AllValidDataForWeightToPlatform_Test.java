 ...
 * */
public class SendGoodsPage_501_Enterprise_AllValidDataForWeightToPlatform_Test extends BaseParpare {

	@Test(dataProvider = "data")
	public void sendAllValidDataForWeightToPlatamSuccessTest(ITestContext context, Map<String, String> data) {
