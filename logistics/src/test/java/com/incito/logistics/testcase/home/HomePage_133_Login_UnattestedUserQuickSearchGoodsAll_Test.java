...
/**
 * @author xy-incito-wy
 * @Description 登录情况下 未认证用户进行快速查找货源操作，输入发货地和收货地，点击查询按钮之后，页面跳转到找货源页面并且查询出了正确的数据
 * 
 * */
public class HomePage_133_Login_UnattestedUserQuickSearchGoodsAll_Test extends HomeUnattestedFather {
	@Test(dataProvider="data")
	public void loginUnattestedUserQuickSearchGoodsAll(ITestContext context,Map<String,String> data) {
