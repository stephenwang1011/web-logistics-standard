...
/**
 * @author xy-incito-wk
 * @Description 认证驳回的用户，进入我的资料-基本信息模块，检测UI（包括编辑页面和未编辑页面）
 *
 * */
public class UserBaseInfoPage_301_AttestReject_UICheck_Test extends UserBaseInfoAttestRejectFather {
	@Test
	public void checkUIForAttestRejectUser(ITestContext context) {
		UserBaseInfoAttestRejectFather.userBaseInfoParpare(context, seleniumUtil, false);
