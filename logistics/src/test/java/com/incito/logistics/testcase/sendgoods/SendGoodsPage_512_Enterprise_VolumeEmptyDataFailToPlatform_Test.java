 ...
 * */
public class SendGoodsPage_512_Enterprise_VolumeEmptyDataFailToPlatform_Test extends BaseParpare {

	@Test(dataProvider="data")
	public void sendVolumeEmptyDataFailToPlatformFailTest(ITestContext context,Map<String, String> data) {
		...
		SendGoodsForEnterprisePageHelper.typeGoodsInfo(seleniumUtil,"发布到平台", SendGoodsForEnterprisePage.SGP_RADIOBOX_LIGHTGOODS, SendGoodsForEnterprisePage.SGP_BUTTON_GOODSDATE7, 
