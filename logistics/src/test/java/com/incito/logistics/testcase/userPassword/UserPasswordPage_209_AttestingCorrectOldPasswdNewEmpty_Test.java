 ...
 * 
 * @author xy-incito-wy
 * @Decription 认证审核中的用户登录之后，进入修改密码页面，输入正确的当前密码，新密码为空,确认密码不为空，点击提交按钮，不能修改提交成功
 */
public class UserPasswordPage_209_AttestingCorrectOldPasswdNewEmpty_Test extends UserPasswordAttestingFather{
	
	@Test(dataProvider="data")
	public void correctOldPasswdNewEmptyForAttestingUser(ITestContext context,Map<String,String> data){
