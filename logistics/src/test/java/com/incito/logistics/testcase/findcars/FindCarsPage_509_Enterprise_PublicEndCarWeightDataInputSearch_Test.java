...
/**
 * @author xy-incito-wy
 * @Description 企业账户下，找车源，只输入车长：结束车重
 * */
public class FindCarsPage_509_Enterprise_PublicEndCarWeightDataInputSearch_Test extends BaseParpare {

	@Test(dataProvider = "data")
	public void publicEndCarWeightDataInputSearchForEnterprise(ITestContext context, Map<String, String> data) {
