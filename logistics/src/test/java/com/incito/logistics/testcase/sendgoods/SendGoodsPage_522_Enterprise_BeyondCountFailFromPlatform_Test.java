 ...
 * */
public class SendGoodsPage_522_Enterprise_BeyondCountFailFromPlatform_Test extends BaseParpare {

	@Test(dataProvider = "data")
	public void sendBeyondCountFailFromPlatform(ITestContext context, Map<String, String> data) {
