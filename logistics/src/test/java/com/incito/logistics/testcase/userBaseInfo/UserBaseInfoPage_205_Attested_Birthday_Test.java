...
/**
 * @author xy-incito-wk
 * @Description 认证用户，进入我的资料-基本信息模块，修改用户生日信息并检测是不是修改成功
 *
 * */
public class UserBaseInfoPage_205_Attested_Birthday_Test extends UserBaseInfoAttestedFather {
	@Test(dataProvider = "data")
	public void modifyBirthForAttestedUser(ITestContext context, Map<String, String> data) {
