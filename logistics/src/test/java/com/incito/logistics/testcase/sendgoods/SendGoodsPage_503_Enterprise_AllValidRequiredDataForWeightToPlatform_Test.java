 ...
 * */
public class SendGoodsPage_503_Enterprise_AllValidRequiredDataForWeightToPlatform_Test extends BaseParpare {

	@Test(dataProvider = "data")
	public void sendAllValidRequiredDataForWeightToPlatamSuccessTest(ITestContext context, Map<String, String> data) {
		...
		SendGoodsForEnterprisePageHelper.typeGoodsInfo(seleniumUtil,"发布到平台", SendGoodsForEnterprisePage.SGP_RADIOBOX_DEVICEGOODS, SendGoodsForEnterprisePage.SGP_BUTTON_GOODSDATE3, 
