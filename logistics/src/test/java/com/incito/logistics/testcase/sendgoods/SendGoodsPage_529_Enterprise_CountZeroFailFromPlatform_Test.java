 ...
 * */
public class SendGoodsPage_529_Enterprise_CountZeroFailFromPlatform_Test extends BaseParpare {

	@Test(dataProvider = "data")
	public void sendCountZeroFailFromPlatform(ITestContext context, Map<String, String> data) {
