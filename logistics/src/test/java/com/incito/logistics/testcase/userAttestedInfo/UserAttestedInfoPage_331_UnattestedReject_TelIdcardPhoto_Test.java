 ...
 *
 * */
public class UserAttestedInfoPage_331_UnattestedReject_TelIdcardPhoto_Test extends UserAttestedInfoAttestRejectFather {
	@Test(dataProvider = "data")
	public void userAttestedInfoPageUnattestedRejectTelIdcardPhotoTest(ITestContext context, Map<String, String> data) {
