 ...
 * */
public class SendGoodsPage_507_Enterprise_AllEmptyDataFailVolumeToPlatform_Test extends BaseParpare {

	@Test(dataProvider="data")
	public void sendAllEmptyDataFailVolumeToPlatform(ITestContext context,Map<String, String> data) {
