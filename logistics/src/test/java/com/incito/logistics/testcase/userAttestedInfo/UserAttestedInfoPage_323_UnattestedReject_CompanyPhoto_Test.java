 ...
 *
 * */
public class UserAttestedInfoPage_323_UnattestedReject_CompanyPhoto_Test extends UserAttestedInfoAttestRejectFather {
	@Test(dataProvider = "data")
	public void userAttestedInfoPageUnattestedRejectCompanyPhotoTest(ITestContext context, Map<String, String> data) {
