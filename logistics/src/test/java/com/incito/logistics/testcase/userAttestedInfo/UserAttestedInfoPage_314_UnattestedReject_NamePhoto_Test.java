 ...
 *
 * */
public class UserAttestedInfoPage_314_UnattestedReject_NamePhoto_Test extends UserAttestedInfoAttestRejectFather {
	@Test(dataProvider = "data")
	public void userAttestedInfoPageUnattestedRejectNamePhotoTest(ITestContext context, Map<String, String> data) {
