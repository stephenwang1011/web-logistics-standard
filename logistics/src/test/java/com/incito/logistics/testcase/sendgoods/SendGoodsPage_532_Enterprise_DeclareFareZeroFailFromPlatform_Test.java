 ...
 * */
public class SendGoodsPage_532_Enterprise_DeclareFareZeroFailFromPlatform_Test extends BaseParpare {

	@Test(dataProvider = "data")
	public void sendDeclareFareZeroFailFromPlatform(ITestContext context, Map<String, String> data) {
