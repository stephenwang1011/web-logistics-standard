 ...
 * */
public class SendGoodsPage_523_Enterprise_BeyondInfofareFailFromPlatform_Test extends BaseParpare {

	@Test(dataProvider = "data")
	public void sendBeyondInfofareFailFromPlatform(ITestContext context, Map<String, String> data) {
