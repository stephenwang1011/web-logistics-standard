...
/**
 * @author xy-incito-wy
 * @Description 测试用例：发布货源，体积0方
 * */
public class SendGoodsPage_028_Volume_Zero_Fail_Test extends SendGoodsFather {

	@Test(dataProvider = "data")
	public void sendVolumeZeroFailTest(ITestContext context, Map<String, String> data) {
