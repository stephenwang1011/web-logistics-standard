...
/**
 * @author xy-incito-wk
 * @Description 认证驳回的用户，进入我的资料-基本信息模块，修改生日和电子邮件并检测是不是修改成功
 *
 * */
public class UserBaseInfoPage_312_AttestReject_BirthdayEmail_Test extends UserBaseInfoAttestRejectFather {
	@Test(dataProvider = "data")
	public void modifyBirthAndEmailForAttestRejectUser(ITestContext context, Map<String, String> data) {
