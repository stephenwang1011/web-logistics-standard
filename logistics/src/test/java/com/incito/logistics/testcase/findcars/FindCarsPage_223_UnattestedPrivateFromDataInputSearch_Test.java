...
/**
 * @author xy-incito-wy
 * @Description 未认证用户，在找车源-我的收藏模块中，输入发货地检索条件，可以准确查出正确的数据
 * */
public class FindCarsPage_223_UnattestedPrivateFromDataInputSearch_Test extends FindCarsUnattestedFather {

	@Test(dataProvider = "data")
	public void unattestedPrivateFromDataInputSearch(ITestContext context, Map<String, String> data) {
