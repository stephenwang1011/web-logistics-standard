 ...
 */
public class UserPasswordPage_015_AuthenticatedModifyPasswordSuccess_Test extends UserPasswordFather{
	
	@Test(dataProvider="data")
	public void allEmptyForAuthenticatedUser(ITestContext context,Map<String,String> data){
