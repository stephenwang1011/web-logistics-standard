 ...
 * 
 * @author xy-incito-wy
 * @Decription 认证驳回的用户登录之后，进入修改密码页面，前密码为空，新密码和确认密码不为空，但是不相同，点击提交按钮，不能修改提交成功
 */
public class UserPasswordPage_312_AttestRejectOldPasswdEmptyOthersNotEmptyDiff_Test extends UserPasswordAttestRejectFather{
	
	@Test(dataProvider="data")
	public void oldPasswdEmptyOthersNotEmptyDiffForAttestRejectUser(ITestContext context,Map<String,String> data){
