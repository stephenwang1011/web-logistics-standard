 ...
 *
 * */
public class UserAttestedInfoPage_327_UnattestedReject_NameTelAddress_Test extends UserAttestedInfoAttestRejectFather {
	@Test(dataProvider = "data")
	public void userAttestedInfoPageUnattestedRejectNameTelAddressTest(ITestContext context, Map<String, String> data) {
