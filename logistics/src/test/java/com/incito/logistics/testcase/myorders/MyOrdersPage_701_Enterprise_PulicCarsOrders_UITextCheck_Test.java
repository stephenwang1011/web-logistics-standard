...
public class MyOrdersPage_701_Enterprise_PulicCarsOrders_UITextCheck_Test extends BaseParpare {
	@Test
	public void myOrdersUiTest(ITestContext context) {
		...
		MyOrdersPageHelper.waitForMyOrdersPageToLoad(seleniumUtil, timeOut);
		MyOrdersPageHelper.checkMyOrdersPageTextForSocietyCarsOrders(seleniumUtil);
