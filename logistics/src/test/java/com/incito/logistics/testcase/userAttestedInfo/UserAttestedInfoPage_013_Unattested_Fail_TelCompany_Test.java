...
/**
 * @author xy-incito-wk
 * @Description 认证信息界面，未认证用户，填写信息联系方式和身份证号提交
 *
 * */
public class UserAttestedInfoPage_013_Unattested_Fail_TelCompany_Test extends UserAttestedInfoUnattestedFather {
	@Test(dataProvider = "data")
	public void UserAttestedInfoPageUnattestedFailTelCompanyTest(ITestContext context, Map<String, String> data) {
