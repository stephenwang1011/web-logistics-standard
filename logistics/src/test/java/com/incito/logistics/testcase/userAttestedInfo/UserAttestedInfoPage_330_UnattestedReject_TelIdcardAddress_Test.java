 ...
 *
 * */
public class UserAttestedInfoPage_330_UnattestedReject_TelIdcardAddress_Test extends UserAttestedInfoAttestRejectFather {
	@Test(dataProvider = "data")
	public void userAttestedInfoPageUnattestedRejectTelIdcardAddressTest(ITestContext context, Map<String, String> data) {
