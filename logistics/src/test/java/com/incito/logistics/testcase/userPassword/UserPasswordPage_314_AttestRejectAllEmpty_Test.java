 ...
 */
public class UserPasswordPage_314_AttestRejectAllEmpty_Test extends UserPasswordAttestRejectFather{
	
	@Test(dataProvider="data")
	public void allEmptyForAttestRejectUser(ITestContext context,Map<String,String> data){
