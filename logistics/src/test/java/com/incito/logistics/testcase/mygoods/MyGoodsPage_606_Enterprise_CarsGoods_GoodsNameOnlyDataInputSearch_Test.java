...
/**
 * @author xy-incito-wk
 * @Description 测试用例：查找我的货源-只输入货物名字
 * */
public class MyGoodsPage_606_Enterprise_CarsGoods_GoodsNameOnlyDataInputSearch_Test extends BaseParpare {
	...
	public void goodsNameOnlyDataInputSearch(ITestContext context, Map<String, String> data) {
		...
		MyGoodsPageHelper.checkGoodsName_EP(seleniumUtil,MyGoodsPage.MGP_SPAN_GOODSNAME_EP,data.get("MGP_INPUT_GOODSNAME"));
