...
/**
 * @author xy-incito-wy
 * @Description 企业账户下的-找车源，所有输入然后点击搜索按钮
 * */
public class FindCarsPage_502_Enterprise_PublicAllDataInputSearch_Test extends BaseParpare {

	@Test(dataProvider = "data")
	public void publicAllDataInputSearchForEnterprise(ITestContext context, Map<String, String> data) {
