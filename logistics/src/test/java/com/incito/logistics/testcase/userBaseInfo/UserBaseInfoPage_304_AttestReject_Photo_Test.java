...
/**
 * @author xy-incito-wk
 * @Description 认证驳回的用户，进入我的资料-基本信息模块，修改用户的头像并检测是不是修改成功
 *
 * */
public class UserBaseInfoPage_304_AttestReject_Photo_Test extends UserBaseInfoAttestRejectFather {
	@Test
	public void modifyPhotoForAttestRejectUser(ITestContext context) {
