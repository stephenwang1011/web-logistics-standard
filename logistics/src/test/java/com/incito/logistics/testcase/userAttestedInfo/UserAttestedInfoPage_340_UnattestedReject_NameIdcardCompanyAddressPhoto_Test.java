 ...
 *
 * */
public class UserAttestedInfoPage_340_UnattestedReject_NameIdcardCompanyAddressPhoto_Test extends UserAttestedInfoAttestRejectFather {
	@Test(dataProvider = "data")
	public void userAttestedInfoPageUnattestedRejectNameIdcardCompanyAddressPhotoTest(ITestContext context, Map<String, String> data) {
