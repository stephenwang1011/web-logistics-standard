...
/**
 * @author xy-incito-wk
 * @Description 认证用户，进入我的资料-基本信息模块,修改：生日、QQ、Email并检测是不是修改成功
 *
 * */
public class UserBaseInfoPage_217_Attested_BirthdayQQEmail_Test extends UserBaseInfoAttestedFather {
	@Test(dataProvider = "data")
	public void modifyBirthdayQQEmailForAttestedUser(ITestContext context, Map<String, String> data) {
