 ...
 *
 * */
public class UserAttestedInfoPage_336_UnattestedReject_NameTelIdcardCompanyAddress_Test extends UserAttestedInfoAttestRejectFather {
	@Test(dataProvider = "data")
	public void userAttestedInfoPageUnattestedRejectNameTelIdcardCompanyAddressTest(ITestContext context, Map<String, String> data) {
