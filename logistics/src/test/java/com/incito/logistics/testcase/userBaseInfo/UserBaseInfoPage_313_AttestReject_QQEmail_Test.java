...
/**
 * @author xy-incito-wk
 * @Description 认证驳回用户，进入我的资料-基本信息模块，修改QQ和email并检测是不是修改成功
 *
 * */
public class UserBaseInfoPage_313_AttestReject_QQEmail_Test extends UserBaseInfoAttestRejectFather {
	@Test(dataProvider = "data")
	public void modifyQQEmailForAttestRejectUser(ITestContext context, Map<String, String> data) {
