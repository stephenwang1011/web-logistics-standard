...
/**
 * @author xy-incito-wy
 * @Description 登录情况下 进行快速查找 自有车队订单，从货源平台预定的产生的订单
 * 
 * */
public class HomePage_512_Login_Enterprise_QuickSearchOrders_Test extends BaseParpare {
	@Test(dataProvider="data")
	public void enterPriseQuickSearchPublicOrders(ITestContext context,Map<String,String> data) {
