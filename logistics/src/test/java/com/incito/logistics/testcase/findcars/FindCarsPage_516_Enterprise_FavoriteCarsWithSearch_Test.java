 ...
 * */
public class FindCarsPage_516_Enterprise_FavoriteCarsWithSearch_Test extends BaseParpare {

	@Test(dataProvider = "data")
	public void favoriteCarsWithSearchForEnterprise(ITestContext context, Map<String, String> data) {
