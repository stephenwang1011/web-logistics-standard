...
/**
 * @author xy-incito-wy
 * @Description 测试用例：发布货源，不输入任何内容点击发布按钮(针对 是抛货的情况下)
 * */
public class SendGoodsPage_506_Enterprise_AllEmptyDataFailWeightToPlatform_Heavy_Test extends BaseParpare {

	@Test(dataProvider="data")
	public void sendAllEmptyDataFailWeightToPlatformForHeavyTest(ITestContext context,Map<String, String> data) {
		...
		SendGoodsForEnterprisePageHelper.typeGoodsInfo(seleniumUtil,"发布到平台", SendGoodsForEnterprisePage.SGP_RADIOBOX_HEAVYGOODS, SendGoodsForEnterprisePage.SGP_BUTTON_GOODSDATE3, 
