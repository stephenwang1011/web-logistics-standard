...
public class MyOrdersPage_012_HarvestCompany_Test extends MyOrdersFather {
	@Test(dataProvider = "data")
	public void searchHarvestCompany(ITestContext context, Map<String, String> data) {
		...
		MyOrdersPageHelper.checkHarvestCompany(seleniumUtil, MyOrdersPage.MOP_TEXT_ORDERSINFOES, MyOrdersPage.MOP_TEXT_ORDERRECEIVERNAME, 
				data.get("MOP_INPUT_HARVESTCOMPANY"));
	}
