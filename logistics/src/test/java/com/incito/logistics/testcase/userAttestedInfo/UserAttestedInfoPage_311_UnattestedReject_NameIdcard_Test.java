 ...
 *
 * */
public class UserAttestedInfoPage_311_UnattestedReject_NameIdcard_Test extends UserAttestedInfoAttestRejectFather {
	@Test(dataProvider = "data")
	public void userAttestedInfoPageUnattestedRejectNameIdcardTest(ITestContext context, Map<String, String> data) {
