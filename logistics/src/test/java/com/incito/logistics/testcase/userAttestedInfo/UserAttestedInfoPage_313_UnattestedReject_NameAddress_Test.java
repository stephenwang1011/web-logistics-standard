 ...
 *
 * */
public class UserAttestedInfoPage_313_UnattestedReject_NameAddress_Test extends UserAttestedInfoAttestRejectFather {
	@Test(dataProvider = "data")
	public void userAttestedInfoPageUnattestedRejectNameAddressTest(ITestContext context, Map<String, String> data) {
