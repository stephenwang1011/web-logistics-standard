 ...
 * */
public class SendGoodsPage_533_Enterprise_AllInputZeroFailFromPlatform_Test extends BaseParpare {

	@Test(dataProvider = "data")
	public void sendAllInputZeroFailFromPlatform(ITestContext context, Map<String, String> data) {
