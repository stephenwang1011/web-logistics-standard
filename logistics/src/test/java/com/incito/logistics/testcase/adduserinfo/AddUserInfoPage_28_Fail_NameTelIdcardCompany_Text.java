 ...
 *
 * */
public class AddUserInfoPage_28_Fail_NameTelIdcardCompany_Text extends BaseParpare {
	@Test
	public void addUserInfoPageFailNameTelIdcardCompany(ITestContext context) {
		...
		AddUserInfoPagerHelper.checkAddUserInfoPrompt_NameTelIdcardCompany(timeOut, seleniumUtil);
	}
