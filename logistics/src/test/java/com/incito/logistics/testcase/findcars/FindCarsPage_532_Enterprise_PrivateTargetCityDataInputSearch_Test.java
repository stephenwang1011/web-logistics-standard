 ...
 * */
public class FindCarsPage_532_Enterprise_PrivateTargetCityDataInputSearch_Test extends BaseParpare {

	@Test(dataProvider = "data")
	public void privateTargetCityDataInputSearchForEnterprise(ITestContext context, Map<String, String> data) {
