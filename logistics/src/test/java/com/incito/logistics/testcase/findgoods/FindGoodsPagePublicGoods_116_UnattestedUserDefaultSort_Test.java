 ...
 * 
 * @author xy-incito-wk
 * @Description 测试用例：已登录的情况下，未认证的用户登录，点击公共货源下，找货源模块，公共货源上的默认排序功能
 */
public class FindGoodsPagePublicGoods_116_UnattestedUserDefaultSort_Test extends FindGoodsUnatestedFather {
	@Test
