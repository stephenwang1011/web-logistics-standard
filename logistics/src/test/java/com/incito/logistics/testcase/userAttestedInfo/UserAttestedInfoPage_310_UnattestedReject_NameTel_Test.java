 ...
 *
 * */
public class UserAttestedInfoPage_310_UnattestedReject_NameTel_Test extends UserAttestedInfoAttestRejectFather {
	@Test(dataProvider = "data")
	public void userAttestedInfoPageUnattestedRejectNameTelTest(ITestContext context, Map<String, String> data) {
