...
/**
 * @author xy-incito-wk
 * @Description 测试用例：查找我的货源-只输入结束货物体积
 * */
public class MyGoodsPage_711_Enterprise_PlatformOrdersGoods_EndVolumeOnlyDataInputSearch_Test extends BaseParpare {

	@Test(dataProvider = "data")
	public void endVolumeOnlyDataInputSearch(ITestContext context, Map<String, String> data) {
