 ...
 * */
public class SendGoodsPage_526_Enterprise_AllInputBeyondFailFromPlatform_Test extends BaseParpare {

	@Test(dataProvider = "data")
	public void sendAllInputBeyondFailFromPlatform(ITestContext context, Map<String, String> data) {
