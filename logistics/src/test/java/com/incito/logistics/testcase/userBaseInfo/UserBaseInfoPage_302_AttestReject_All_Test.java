...
/**
 * @author xy-incito-wk
 * @Description 认证驳回的用户，进入我的资料-基本信息模块，修改所有信息并检测是不是修改成功
 *
 * */
public class UserBaseInfoPage_302_AttestReject_All_Test extends UserBaseInfoAttestRejectFather {
	@Test(dataProvider = "data")
	public void modifyAllInfoForAttestRejectUser(ITestContext context, Map<String, String> data) {
