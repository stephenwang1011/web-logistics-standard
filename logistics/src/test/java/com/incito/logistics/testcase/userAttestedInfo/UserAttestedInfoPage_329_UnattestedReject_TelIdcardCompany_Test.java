 ...
 *
 * */
public class UserAttestedInfoPage_329_UnattestedReject_TelIdcardCompany_Test extends UserAttestedInfoAttestRejectFather {
	@Test(dataProvider = "data")
	public void userAttestedInfoPageUnattestedRejectTelIdcardCompanyTest(ITestContext context, Map<String, String> data) {
