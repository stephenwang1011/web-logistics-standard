 ...
 */
public class UserPasswordPage_113_UnattestedOldPasswdEmptyOthersNotEmptySame_Test extends UserPasswordUnattestedFather{
	
	@Test(dataProvider="data")
	public void oldPasswdEmptyOthersNotEmptySameForUnttestedUser(ITestContext context,Map<String,String> data){
