 ...
 * */
public class FindCarsPage_016_FavoriteCarsWithSearch_Test extends FindCarsFather {

	@Test(dataProvider = "data")
	public void favoriteCarsWithSearch(ITestContext context, Map<String, String> data) {
