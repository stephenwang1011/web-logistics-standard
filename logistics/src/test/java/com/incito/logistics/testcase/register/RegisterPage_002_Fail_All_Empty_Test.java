...
public class RegisterPage_002_Fail_All_Empty_Test extends BaseParpare {
	...
	public void registerFailTest_All_Empty(ITestContext context,Map<String, String> data) {
		...
		RegisterPageHelper.checkRegisterPagePrompt(timeOut, seleniumUtil,data);
