 ...
 *
 * */
public class AddUserInfoPage_16_Fail_IdcardAddress_Text extends BaseParpare {
	@Test
	public void addUserInfoPageFailIdcardAddress(ITestContext context) {
		...
		AddUserInfoPagerHelper.checkAddUserInfoPrompt_IdcardCompany(timeOut, seleniumUtil);
	}
