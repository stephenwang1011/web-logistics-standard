...
/**
 * @author xy-incito-wy
 * @Description 测试用例：发布货源,重量为0吨
 * */
public class SendGoodsPage_027_Weight_Zero_Fail_Test extends SendGoodsFather {

	@Test(dataProvider = "data")
	public void sendWeightZeroFailTest(ITestContext context, Map<String, String> data) {
