 ...
 *
 * */
public class UserAttestedInfoPage_315_UnattestedReject_TelIdcard_Test extends UserAttestedInfoAttestRejectFather {
	@Test(dataProvider = "data")
	public void userAttestedInfoPageUnattestedRejectTelIdcardTest(ITestContext context, Map<String, String> data) {
