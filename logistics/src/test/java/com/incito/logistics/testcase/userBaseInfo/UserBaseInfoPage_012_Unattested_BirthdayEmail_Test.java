...
/**
 * @author xy-incito-wk
 * @Description 未认证的用户，进入我的资料-基本信息模块,修改生日和电子邮件并检测是不是修改成功
 *
 * */
public class UserBaseInfoPage_012_Unattested_BirthdayEmail_Test extends UserBaseInfoUnattestedFather {
	@Test(dataProvider = "data")
	public void modifyBirthAndEmailForUnattestedUser(ITestContext context, Map<String, String> data) {
