 ...
 *
 * */
public class UserAttestedInfoPage_326_UnattestedReject_NameTelCompany_Test extends UserAttestedInfoAttestRejectFather {
	@Test(dataProvider = "data")
	public void userAttestedInfoPageUnattestedRejectNameTelCompanyTest(ITestContext context, Map<String, String> data) {
