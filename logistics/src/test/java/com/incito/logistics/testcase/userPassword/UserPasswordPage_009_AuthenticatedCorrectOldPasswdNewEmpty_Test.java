 ...
 * 
 * @author xy-incito-wy
 * @Decription 已经认证用户登录之后，进入修改密码页面，输入正确的当前密码，新密码为空,确认密码不为空，点击提交按钮，不能修改提交成功
 */
public class UserPasswordPage_009_AuthenticatedCorrectOldPasswdNewEmpty_Test extends UserPasswordFather{
	
	@Test(dataProvider="data")
	public void correctOldPasswdNewEmptyForAuthenticatedUser(ITestContext context,Map<String,String> data){
