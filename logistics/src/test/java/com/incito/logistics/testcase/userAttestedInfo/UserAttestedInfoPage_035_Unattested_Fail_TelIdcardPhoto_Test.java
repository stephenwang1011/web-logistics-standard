...
/**
 * @author xy-incito-wk
 * @Description 认证信息界面，未认证用户，填写信息联系方式、身份证号、上传证件照片
 *
 * */
public class UserAttestedInfoPage_035_Unattested_Fail_TelIdcardPhoto_Test extends UserAttestedInfoUnattestedFather {
	@Test(dataProvider = "data")
	public void UserAttestedInfoPageUnattestedFailTelIdcardPhotoTest(ITestContext context, Map<String, String> data) {
