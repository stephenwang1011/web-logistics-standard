 ...
 * */
public class FindCarsPage_518_Enterprise_DismissCancelFavoriteCars_Test extends BaseParpare {

	@Test(dataProvider = "data")
	public void cancelFavoriteCarsInFavForEnterprise(ITestContext context, Map<String, String> data) {
