 ...
 * */
public class SendGoodsPage_510_Enterprise_GoodsNameEmptyDataFailToPlatform_Test extends BaseParpare {

	@Test(dataProvider="data")
	public void sendGoodsNameEmptyDataFailToPlatformFailTest_(ITestContext context,Map<String, String> data) {
		...
		SendGoodsForEnterprisePageHelper.typeGoodsInfo(seleniumUtil,"发布到平台", SendGoodsForEnterprisePage.SGP_RADIOBOX_DEVICEGOODS, SendGoodsForEnterprisePage.SGP_BUTTON_GOODSDATE7, 
