 ...
 *
 * */
public class AddUserInfoPage_05_Fail_Idcard_Text extends BaseParpare {
	@Test
	public void addUserInfoPageFailIdcard(ITestContext context) {
		...
		AddUserInfoPagerHelper.checkAddUserInfoPrompt_Company(timeOut, seleniumUtil);
