 ...
 */
public class UserPasswordPage_010_AttestedCorrectOldPasswdConfirmEmpty_Test extends UserPasswordAttestedFather{
	
	@Test(dataProvider="data")
	public void correctOldPasswdConfirmEmptyForAttestedUser(ITestContext context,Map<String,String> data){
