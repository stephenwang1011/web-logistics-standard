 ...
 *
 * */
public class AddUserInfoPage_32_Fail_TelIdcardCompanyAddress_Text extends BaseParpare {
	@Test
	public void addUserInfoPageFailTelIdcardCompanyAddress(ITestContext context) {
		...
		AddUserInfoPagerHelper.checkAddUserInfoPrompt_TelIdcardCompanyAddress(timeOut, seleniumUtil);
	}
