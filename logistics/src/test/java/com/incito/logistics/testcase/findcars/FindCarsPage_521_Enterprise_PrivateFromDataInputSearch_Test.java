 ...
 * */
public class FindCarsPage_521_Enterprise_PrivateFromDataInputSearch_Test extends BaseParpare {

	@Test(dataProvider = "data")
	public void privateFromDataInputSearchForEnterprise(ITestContext context, Map<String, String> data) {
