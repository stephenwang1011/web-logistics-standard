 ...
 */
public class UserPasswordPage_315_AttestRejectModifyPasswordSuccess_Test extends UserPasswordAttestRejectFather{
	
	@Test(dataProvider="data")
	public void attestRejectModifyPasswordSuccess(ITestContext context,Map<String,String> data){
		...
		UserPasswordPageHelper.checkModifyPasswdSuccessed(seleniumUtil, sleepTime, timeOut, modifyusername3, data.get("NEW_PASSWORD"));
