 ...
 */
public class UserPasswordPage_013_AuthenticatedOldPasswdEmptyOthersNotEmptySame_Test extends UserPasswordFather{
	
	@Test(dataProvider="data")
	public void oldPasswdEmptyOthersNotEmptySameForAuthenticatedUser(ITestContext context,Map<String,String> data){
