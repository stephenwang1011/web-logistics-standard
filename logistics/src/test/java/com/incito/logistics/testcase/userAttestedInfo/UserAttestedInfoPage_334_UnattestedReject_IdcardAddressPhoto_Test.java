 ...
 *
 * */
public class UserAttestedInfoPage_334_UnattestedReject_IdcardAddressPhoto_Test extends UserAttestedInfoAttestRejectFather {
	@Test(dataProvider = "data")
	public void userAttestedInfoPageUnattestedRejectIdcardAddressPhotoTest(ITestContext context, Map<String, String> data) {
