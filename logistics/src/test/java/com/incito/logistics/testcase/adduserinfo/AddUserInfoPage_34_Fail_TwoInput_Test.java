...
/**
 * @author xy-incito-wk
 * @Description 填写两个文本框点击提交
 *
 * */
public class AddUserInfoPage_34_Fail_TwoInput_Test extends BaseParpare {
	@Test
	public void addUserInfoPageFailTelIdcardCompanyAddress(ITestContext context) {
		...
		// 循环填写一个文本框并检测提示语
		for (int j = 0; j < 5; j++) {
			System.out.println("第"+j+"层循环！！！");
			for (int i = j + 1; i < 5; i++) {// 可以定义i,j,k,l进行几层循环
				System.out.println("第"+j+"层中的，第"+i+"个循环，填写了！！！");
