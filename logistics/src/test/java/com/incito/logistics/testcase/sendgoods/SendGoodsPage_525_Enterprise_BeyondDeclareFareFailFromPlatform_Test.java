 ...
 * */
public class SendGoodsPage_525_Enterprise_BeyondDeclareFareFailFromPlatform_Test extends BaseParpare {

	@Test(dataProvider = "data")
	public void sendBeyondDeclareFareFailFromPlatform(ITestContext context, Map<String, String> data) {
