 ...
 * */
public class SendGoodsPage_528_Enterprise_VolumeZeroFailFromPlatform_Test extends BaseParpare {

	@Test(dataProvider = "data")
	public void sendVolumeZeroFailFromPlatform(ITestContext context, Map<String, String> data) {
