...
/**
 * @author xy-incito-wy
 * @Description 测试用例：发布货源，超过最大声明价值
 * */
public class SendGoodsPage_025_Beyond_Declare_Fare_Fail_Test extends SendGoodsFather {

	@Test(dataProvider = "data")
	public void sendBeyondDeclareFareFailTest(ITestContext context, Map<String, String> data) {
