 ...
 * 
 * */
public class HomePage_109_Login_QuickSearchGoods_Test extends HomeAttestedFather {
	@Test(dataProvider = "data")
	public void toOnlyQuickSearchGoods(ITestContext context, Map<String, String> data) {
