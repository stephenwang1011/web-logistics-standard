...
/**
 * @author xy-incito-wk
 * @Description 测试用例：查找我的货源-只输入结束货物体积和开始体积
 * */
public class MyGoodsPage_712_Enterprise_PlatformOrdersGoods_AllVolumeDataInputSearch_Test extends BaseParpare {

	@Test(dataProvider = "data")
	public void allVolumeDataInputSearch(ITestContext context, Map<String, String> data) {
