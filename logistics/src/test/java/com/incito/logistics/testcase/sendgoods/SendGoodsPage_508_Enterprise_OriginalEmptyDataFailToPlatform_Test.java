 ...
 * */
public class SendGoodsPage_508_Enterprise_OriginalEmptyDataFailToPlatform_Test extends BaseParpare {

	@Test(dataProvider="data")
	public void sendOriginalEmptyDataToPlatformFailTest(ITestContext context,Map<String, String> data) {
