 ...
 *
 * */
public class UserAttestedInfoPage_337_UnattestedReject_NameTelIdcardCompanyPhoto_Test extends UserAttestedInfoAttestRejectFather {
	@Test(dataProvider = "data")
	public void userAttestedInfoPageUnattestedRejectNameTelIdcardCompanyPhotoTest(ITestContext context, Map<String, String> data) {
