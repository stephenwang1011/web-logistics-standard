...
/**
 * @author xy-incito-wk
 * @Description 认证用户，进入我的资料-基本信息模块,修改：头像、QQ、Email并检测是不是修改成功
 *
 * */
public class UserBaseInfoPage_216_Attested_PhotoQQEmail_Test extends UserBaseInfoAttestedFather {
	@Test(dataProvider = "data")
	public void modifyPhotoQQEmailForAttestedUser(ITestContext context, Map<String, String> data) {
