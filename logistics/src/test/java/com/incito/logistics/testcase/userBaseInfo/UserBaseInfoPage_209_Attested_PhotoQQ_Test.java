...
/**
 * @author xy-incito-wk
 * @Description 认证用户，进入我的资料-基本信息模块，修改头像和qq并检测是不是修改成功
 *
 * */
public class UserBaseInfoPage_209_Attested_PhotoQQ_Test extends UserBaseInfoAttestedFather {
	@Test(dataProvider = "data")
	public void modifyQQPhotoForAttestedUser(ITestContext context, Map<String, String> data) {
