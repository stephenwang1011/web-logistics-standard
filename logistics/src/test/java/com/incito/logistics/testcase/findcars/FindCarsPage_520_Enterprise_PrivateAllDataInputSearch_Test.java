...
/**
 * @author xy-incito-wy
 * @Description 企业账户下，找车源中，我的收藏模块，所有的条件输入之后查询
 * */
public class FindCarsPage_520_Enterprise_PrivateAllDataInputSearch_Test extends BaseParpare {

	@Test(dataProvider = "data")
	public void privateAllDataInputSearchForEnterprise(ITestContext context, Map<String, String> data) {
