...
/**
 * @author xy-incito-wk
 * @Description 认证用户，进入我的资料-基本信息模块，修改所有信息并检测是不是修改成功
 *
 * */
public class UserBaseInfoPage_202_Attested_All_Test extends UserBaseInfoAttestedFather {
	@Test(dataProvider = "data")
	public void modifyAllInfoForAttestedUser(ITestContext context, Map<String, String> data) {
