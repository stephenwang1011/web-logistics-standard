 ...
 */
public class UserPasswordPage_115_UnattestedModifyPasswordSuccess_Test extends UserPasswordUnattestedFather{
	
	@Test(dataProvider="data")
	public void unattestedModifyPasswordSuccess(ITestContext context,Map<String,String> data){
		...
		UserPasswordPageHelper.checkModifyPasswdSuccessed(seleniumUtil, sleepTime, timeOut, modifyusername1, data.get("NEW_PASSWORD"));
