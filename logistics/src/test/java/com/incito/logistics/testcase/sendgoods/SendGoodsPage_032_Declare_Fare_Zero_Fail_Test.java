...
/**
 * @author xy-incito-wy
 * @Description 测试用例：发布货源,声明价值0元
 * */
public class SendGoodsPage_032_Declare_Fare_Zero_Fail_Test extends SendGoodsFather {

	@Test(dataProvider = "data")
	public void sendDeclareFareZeroFailTest(ITestContext context, Map<String, String> data) {
