 ...
 *
 * */
public class UserAttestedInfoPage_312_UnattestedReject_NameCompany_Test extends UserAttestedInfoAttestRejectFather {
	@Test(dataProvider = "data")
	public void userAttestedInfoPageUnattestedRejectNameCompanyTest(ITestContext context, Map<String, String> data) {
