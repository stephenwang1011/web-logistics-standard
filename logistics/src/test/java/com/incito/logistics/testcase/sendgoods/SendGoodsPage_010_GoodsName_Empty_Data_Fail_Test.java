...
/**
 * @author xy-incito-wy
 * @Description 测试用例：发布货源界面，不输入货物名称，其他都输入，点击发布货源按钮不能发布成功
 * */
public class SendGoodsPage_010_GoodsName_Empty_Data_Fail_Test extends SendGoodsFather {

	@Test(dataProvider="data")
	public void sendGoodsNameEmptyDataFailTest(ITestContext context,Map<String, String> data) {
