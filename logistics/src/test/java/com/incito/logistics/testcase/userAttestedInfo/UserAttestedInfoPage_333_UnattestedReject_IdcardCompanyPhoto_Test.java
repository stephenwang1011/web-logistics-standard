 ...
 *
 * */
public class UserAttestedInfoPage_333_UnattestedReject_IdcardCompanyPhoto_Test extends UserAttestedInfoAttestRejectFather {
	@Test(dataProvider = "data")
	public void userAttestedInfoPageUnattestedRejectIdcardCompanyPhotoTest(ITestContext context, Map<String, String> data) {
