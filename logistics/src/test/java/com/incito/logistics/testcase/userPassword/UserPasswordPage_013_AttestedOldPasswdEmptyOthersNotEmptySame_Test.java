 ...
 */
public class UserPasswordPage_013_AttestedOldPasswdEmptyOthersNotEmptySame_Test extends UserPasswordAttestedFather{
	
	@Test(dataProvider="data")
	public void oldPasswdEmptyOthersNotEmptySameForAttestedUser(ITestContext context,Map<String,String> data){
