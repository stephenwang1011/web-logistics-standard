 ...
 *
 * */
public class AddUserInfoPage_30_Fail_NameTelCompanyAddress_Text extends BaseParpare {
	@Test
	public void addUserInfoPageFailNameTelCompanyAddress(ITestContext context) {
		...
		AddUserInfoPagerHelper.checkAddUserInfoPrompt_NameTelCompanyAddress(timeOut, seleniumUtil);
	}
