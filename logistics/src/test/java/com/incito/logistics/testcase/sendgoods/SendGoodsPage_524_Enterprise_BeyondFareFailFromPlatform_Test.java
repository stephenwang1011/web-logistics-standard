 ...
 * */
public class SendGoodsPage_524_Enterprise_BeyondFareFailFromPlatform_Test extends BaseParpare {

	@Test(dataProvider = "data")
	public void sendBeyondFareFailFromPlatform(ITestContext context, Map<String, String> data) {
