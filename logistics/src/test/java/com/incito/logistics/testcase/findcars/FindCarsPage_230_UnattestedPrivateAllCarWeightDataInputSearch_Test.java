...
/**
 * @author xy-incito-wy
 * @Description  未认证用户，在找车源-我的收藏模块中，输入开始和结束吨位检索条件，可以准确查出正确的数据
 * */
public class FindCarsPage_230_UnattestedPrivateAllCarWeightDataInputSearch_Test extends FindCarsUnattestedFather {

	@Test(dataProvider = "data")
	public void unattestedPrivateAllCarWeightDataInputSearch(ITestContext context, Map<String, String> data) {
