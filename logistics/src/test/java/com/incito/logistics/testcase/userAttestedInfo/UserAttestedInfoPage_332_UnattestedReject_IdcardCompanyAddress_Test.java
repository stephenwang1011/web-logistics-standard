 ...
 *
 * */
public class UserAttestedInfoPage_332_UnattestedReject_IdcardCompanyAddress_Test extends UserAttestedInfoAttestRejectFather {
	@Test(dataProvider = "data")
	public void userAttestedInfoPageUnattestedRejectIdcardCompanyAddressTest(ITestContext context, Map<String, String> data) {
