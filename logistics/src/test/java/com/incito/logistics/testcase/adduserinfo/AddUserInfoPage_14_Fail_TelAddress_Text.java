 ...
 *
 * */
public class AddUserInfoPage_14_Fail_TelAddress_Text extends BaseParpare {
	@Test
	public void addUserInfoPageFailTelAddress(ITestContext context) {
		...
		AddUserInfoPagerHelper.checkAddUserInfoPrompt_TelAdress(timeOut, seleniumUtil);
	}
