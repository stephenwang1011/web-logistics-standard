...
/**
 * @author xy-incito-wk
 * @Description 认证驳回的用户，进入我的资料-基本信息模块,修改：头像、QQ、Email并检测是不是修改成功
 *
 * */
public class UserBaseInfoPage_316_AttestReject_PhotoQQEmail_Test extends UserBaseInfoAttestRejectFather {
	@Test(dataProvider = "data")
	public void modifyPhotoQQEmailForAttestRejectUser(ITestContext context, Map<String, String> data) {
