 ...
 * */
public class MyGoodsPage_706_Enterprise_PlatformOrdersGoods_GoodsNameOnlyDataInputSearch_Test extends BaseParpare {
	...
	public void goodsNameOnlyDataInputSearch(ITestContext context, Map<String, String> data) {
		...
		MyGoodsPageHelper.checkGoodsName(seleniumUtil,MyGoodsPage.MGP_ITEM_GOODS,data.get("MGP_INPUT_GOODSNAME"));
