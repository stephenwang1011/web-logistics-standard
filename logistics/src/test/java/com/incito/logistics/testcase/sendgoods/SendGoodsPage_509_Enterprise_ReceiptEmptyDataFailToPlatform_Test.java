 ...
 * */
public class SendGoodsPage_509_Enterprise_ReceiptEmptyDataFailToPlatform_Test extends BaseParpare {

	@Test(dataProvider="data")
	public void sendReceiptEmptyDataFailToPlatformFailTest(ITestContext context,Map<String, String> data) {
