 ...
 * */
public class SendGoodsPage_539_Enterprise_ClearAllVolumeFromPlatform_Test extends BaseParpare {

	@Test(dataProvider = "data")
	public void clearAllVolumeFromPlatform(ITestContext context, Map<String, String> data) {
		...
		SendGoodsForEnterprisePageHelper.enterPage(seleniumUtil, SendGoodsForEnterprisePage.SGP_BUTTON_RESET);
