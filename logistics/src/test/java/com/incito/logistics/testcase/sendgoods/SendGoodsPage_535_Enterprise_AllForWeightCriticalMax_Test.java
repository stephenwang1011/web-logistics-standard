 ...
 * */
public class SendGoodsPage_535_Enterprise_AllForWeightCriticalMax_Test extends BaseParpare {

	@Test(dataProvider = "data")
	public void sendAllForWeightCriticalMax(ITestContext context, Map<String, String> data) {
