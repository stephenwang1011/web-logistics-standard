 ...
 */
public class UserPasswordPage_011_AuthenticatedCorrectOldPasswdOthersNotEmptyDiff_Test extends UserPasswordFather{
	
	@Test(dataProvider="data")
	public void correctOldPasswdOthersNotEmptyDiffForAuthenticatedUser(ITestContext context,Map<String,String> data){
