 ...
 * */
public class SendGoodsPage_534_Enterprise_AllForWeightCriticalMin_Test extends BaseParpare {

	@Test(dataProvider = "data")
	public void sendAllForWeightCriticalMin(ITestContext context, Map<String, String> data) {
