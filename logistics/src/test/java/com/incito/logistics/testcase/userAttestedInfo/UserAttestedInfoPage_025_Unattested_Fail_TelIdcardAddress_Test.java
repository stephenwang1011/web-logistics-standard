...
/**
 * @author xy-incito-wk
 * @Description 认证信息界面，未认证用户，填写联系方式，身份证号，公司地址点击提交
 *
 * */
public class UserAttestedInfoPage_025_Unattested_Fail_TelIdcardAddress_Test extends UserAttestedInfoUnattestedFather {
	@Test(dataProvider = "data")
	public void UserAttestedInfoPageUnattestedFailTelIdcardAddressTest(ITestContext context, Map<String, String> data) {
