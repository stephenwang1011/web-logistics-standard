 ...
 *
 * */
public class AddUserInfoPage_26_Fail_TelCompanyAddress_Test extends BaseParpare {
	@Test
	public void addUserInfoPageFailTelCompanyAddress(ITestContext context) {
		...
		AddUserInfoPagerHelper.checkAddUserInfoPrompt_TelCompanyAddress(timeOut, seleniumUtil);
	}
