 ...
 */
public class UserPasswordPage_005_AttestedIncorrectOldPasswdNewEmpty_Test extends UserPasswordAttestedFather{
	
	@Test(dataProvider="data")
	public void incorrectOldPasswdNewEmptyForAttestedUser(ITestContext context,Map<String,String> data){
