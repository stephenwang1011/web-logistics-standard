 ...
 * */
public class SendGoodsPage_537_Enterprise_AllForVolumeCriticalMax_Test extends BaseParpare {

	@Test(dataProvider = "data")
	public void sendAllForVolumeCriticalMax(ITestContext context, Map<String, String> data) {
