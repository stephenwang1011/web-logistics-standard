...
/**
 * @author xy-incito-wy
 * @Description 测试用例：发布货源，所有的输入合法有效，然后点击发布按钮确认是否发布成功（体积）：只填 必填项
 * */
public class SendGoodsPage_504_Enterprise_AllValidRequiredDataForVolumeToPlatform_Test extends BaseParpare {

	@Test(dataProvider = "data")
	public void sendAllValidRequiredDataForVolumeToPlatformSuccessTest(ITestContext context, Map<String, String> data) {
