 ...
 *
 * */
public class UserAttestedInfoPage_203_Attested_PassWord_Test extends UserAttestedInfoAttestedFather {
	@Test
	public void UserAttestingInfoPageAttestedPassWordTest(ITestContext context) {
		...
		seleniumUtil.type(seleniumUtil.findElementBy(UserAttestedInfoPage.UAIP_INPUT_TEL), "15316225442");
