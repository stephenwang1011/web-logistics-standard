 ...
 *
 * */
public class AddUserInfoPage_06_Fail_Company_Text extends BaseParpare {
	@Test
	public void addUserInfoPageFailCompany(ITestContext context) {
		...
		AddUserInfoPagerHelper.checkAddUserInfoPrompt_Idcard(timeOut, seleniumUtil);
