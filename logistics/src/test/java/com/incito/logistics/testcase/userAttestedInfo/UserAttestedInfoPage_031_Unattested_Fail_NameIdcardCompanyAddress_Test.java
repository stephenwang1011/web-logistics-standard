...
/**
 * @author xy-incito-wk
 * @Description 认证信息界面，未认证用户，填写姓名，身份证号，公司名称，公司地址点击提交
 *
 * */
public class UserAttestedInfoPage_031_Unattested_Fail_NameIdcardCompanyAddress_Test extends UserAttestedInfoUnattestedFather {
	@Test(dataProvider = "data")
	public void UserAttestedInfoPageUnattestedFailNameIdcardCompanyAddressTest(ITestContext context, Map<String, String> data) {
