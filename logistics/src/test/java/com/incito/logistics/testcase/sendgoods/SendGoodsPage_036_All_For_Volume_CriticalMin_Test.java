...
/**
 * @author xy-incito-wy
 * @Description 测试用例：发布货源：所有输入值最小值
 * */
public class SendGoodsPage_036_All_For_Volume_CriticalMin_Test extends SendGoodsFather {

	@Test(dataProvider = "data")
	public void sendAllForWeightCriticalMinTest(ITestContext context, Map<String, String> data) {
