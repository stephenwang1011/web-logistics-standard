 ...
 * 
 * @author xy-incito-wk
 * @Description 测试用例：已登录的情况下，未认证的用户登录，点击我的收藏，在搜索条件下选择体积输入体积的一个区间，检查搜索结果
 */
public class FindGoodsPagePrivateGoods_115_UnattestedUserAllVolumeData_Test extends FindGoodsUnatestedFather {
	@Test(dataProvider = "data")
	public void unattestedUserAllVolumeData(ITestContext context, Map<String, String> data) {
