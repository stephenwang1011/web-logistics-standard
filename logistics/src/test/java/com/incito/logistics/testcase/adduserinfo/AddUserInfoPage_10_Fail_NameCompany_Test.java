 ...
 *
 * */
public class AddUserInfoPage_10_Fail_NameCompany_Test extends BaseParpare {
	@Test
	public void addUserInfoPageFailNameCompany(ITestContext context) {
		...
		AddUserInfoPagerHelper.checkAddUserInfoPrompt_NameCompany(timeOut, seleniumUtil);
