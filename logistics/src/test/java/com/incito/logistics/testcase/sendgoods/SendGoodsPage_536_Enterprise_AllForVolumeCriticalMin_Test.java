 ...
 * */
public class SendGoodsPage_536_Enterprise_AllForVolumeCriticalMin_Test extends BaseParpare {

	@Test(dataProvider = "data")
	public void sendAllForVolumeCriticalMin(ITestContext context, Map<String, String> data) {
