...
/**
 * @author xy-incito-wy
 * @Description 测试用例：发布货源，信息费超过10000
 * */
public class SendGoodsPage_023_Beyond_InfoFare_Fail_Test extends BaseParpare {

	@Test(dataProvider = "data")
	public void sendBeyondInfoFareFailTest(ITestContext context, Map<String, String> data) {
