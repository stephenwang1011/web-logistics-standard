 ...
 *
 * */
public class UserAttestedInfoPage_324_UnattestedReject_AddressPhoto_Test extends UserAttestedInfoAttestRejectFather {
	@Test(dataProvider = "data")
	public void userAttestedInfoPageUnattestedRejectAddressPhotoTest(ITestContext context, Map<String, String> data) {
