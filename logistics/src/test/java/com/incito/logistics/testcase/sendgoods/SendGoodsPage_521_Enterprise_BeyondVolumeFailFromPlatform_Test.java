 ...
 * */
public class SendGoodsPage_521_Enterprise_BeyondVolumeFailFromPlatform_Test extends BaseParpare {

	@Test(dataProvider = "data")
	public void sendBeyondVolumeFailFromPlatform(ITestContext context, Map<String, String> data) {
