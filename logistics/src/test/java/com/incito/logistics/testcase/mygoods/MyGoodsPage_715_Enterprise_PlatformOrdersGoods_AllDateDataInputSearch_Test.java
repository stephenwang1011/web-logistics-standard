...
/**
 * @author xy-incito-wk
 * @Description 测试用例：查找我的货源-只输入发布的结束时间和开始时间
 * */
public class MyGoodsPage_715_Enterprise_PlatformOrdersGoods_AllDateDataInputSearch_Test extends BaseParpare {

	@Test(dataProvider = "data")
	public void allDateDataInputSearch(ITestContext context, Map<String, String> data) {
