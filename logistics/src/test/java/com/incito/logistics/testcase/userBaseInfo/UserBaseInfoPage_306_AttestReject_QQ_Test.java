...
/**
 * @author xy-incito-wk
 * @Description 认证驳回的用户，进入我的资料-基本信息模块，修改用户qq并检测是不是修改成功
 *
 * */
public class UserBaseInfoPage_306_AttestReject_QQ_Test extends UserBaseInfoAttestRejectFather {
	@Test(dataProvider = "data")
	public void modifyQQForAttestRejectUser(ITestContext context, Map<String, String> data) {
