...
/**
 * @author xy-incito-wy
 * @Description 企业账户 下 找车源，输入开始和结束车长进行搜索 
 * */
public class FindCarsPage_510_Enterprise_PublicAllCarWeightDataInputSearch_Test extends BaseParpare {

	@Test(dataProvider = "data")
	public void publicAllCarWeightDataInputSearchForEnterprise(ITestContext context, Map<String, String> data) {
