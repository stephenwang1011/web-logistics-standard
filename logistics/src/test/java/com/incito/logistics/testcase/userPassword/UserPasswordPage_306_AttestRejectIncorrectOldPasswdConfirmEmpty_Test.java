 ...
 * 
 * @author xy-incito-wy
 * @Decription 认证驳回的用户登录之后，进入修改密码页面，输入错误的当前密码，新密码不为空,确认密码为空，点击提交按钮，不能修改提交成功
 */
public class UserPasswordPage_306_AttestRejectIncorrectOldPasswdConfirmEmpty_Test extends UserPasswordAttestRejectFather{
	
	@Test(dataProvider="data")
	public void incorrectOldPasswdConfirmEmptyForAttestRejectUser(ITestContext context,Map<String,String> data){
