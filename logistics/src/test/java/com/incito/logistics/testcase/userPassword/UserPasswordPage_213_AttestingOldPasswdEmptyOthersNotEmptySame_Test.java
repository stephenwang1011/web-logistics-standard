 ...
 */
public class UserPasswordPage_213_AttestingOldPasswdEmptyOthersNotEmptySame_Test extends UserPasswordAttestingFather{
	
	@Test(dataProvider="data")
	public void oldPasswdEmptyOthersNotEmptySameForAtttestingUser(ITestContext context,Map<String,String> data){
