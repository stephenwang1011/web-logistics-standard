...
/**
 * @author xy-incito-wy
 * @Description 测试用例：发布货源，体积超过100方
 * */
public class SendGoodsPage_021_Beyond_Volume_Fail_Test extends SendGoodsFather {

	@Test(dataProvider = "data")
	public void sendBeyondVolumeFailTest(ITestContext context, Map<String, String> data) {
