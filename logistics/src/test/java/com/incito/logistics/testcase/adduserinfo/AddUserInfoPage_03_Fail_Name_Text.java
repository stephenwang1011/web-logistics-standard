 ...
 *
 * */
public class AddUserInfoPage_03_Fail_Name_Text extends BaseParpare {
	@Test
	public void addUserInfoPageFailName(ITestContext context) {
		...
		AddUserInfoPagerHelper.checkAddUserInfoPrompt_Name(timeOut, seleniumUtil);
