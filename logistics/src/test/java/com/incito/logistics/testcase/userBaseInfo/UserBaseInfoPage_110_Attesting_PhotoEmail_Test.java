...
/**
 * @author xy-incito-wk
 * @Description 认证中的用户，进入我的资料-基本信息模块,修改头像和email并检测是不是修改成功
 *
 * */
public class UserBaseInfoPage_110_Attesting_PhotoEmail_Test extends UserBaseInfoAttestingFather {
	@Test(dataProvider = "data")
	public void modifyPhotoAndEmailForUnattestingUser(ITestContext context, Map<String, String> data) {
