 ...
 *
 * */
public class AddUserInfoPage_23_Fail_NameCompanyAddress_Text extends BaseParpare {
	@Test
	public void addUserInfoPageFailNameCompanyAddress(ITestContext context) {
		...
		AddUserInfoPagerHelper.checkAddUserInfoPrompt_NameCompanyAddress(timeOut, seleniumUtil);
	}
