...
/**
 * @author xy-incito-wk
 * @Description 测试用例：查找我的货源-只输入货源编号
 * */
public class MyGoodsPage_603_Enterprise_CarsGoods_GoodsNoOnlyDataInputSearch_Test extends BaseParpare {

	@Test(dataProvider = "data")
	public void goodsNoOnlyDataInputSearch(ITestContext context, Map<String, String> data) {
		...
		MyGoodsPageHelper.checkGoodsAddress(seleniumUtil, MyGoodsPage.MGP_SPAN_ADDRESS_EP, data.get("ORIGINAL_ADDRESS"),data.get("TARGET_ADDRESS"));
	}
