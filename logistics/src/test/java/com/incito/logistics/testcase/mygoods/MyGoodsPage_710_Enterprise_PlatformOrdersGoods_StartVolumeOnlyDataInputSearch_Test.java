...
/**
 * @author xy-incito-wk
 * @Description 测试用例：查找我的货源-只输入开始货物体积
 * */
public class MyGoodsPage_710_Enterprise_PlatformOrdersGoods_StartVolumeOnlyDataInputSearch_Test extends BaseParpare {

	@Test(dataProvider = "data")
	public void startVolumeOnlyDataInputSearch(ITestContext context, Map<String, String> data) {
