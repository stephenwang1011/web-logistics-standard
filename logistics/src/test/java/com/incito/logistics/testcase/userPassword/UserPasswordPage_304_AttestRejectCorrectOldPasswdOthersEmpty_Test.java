 ...
 * 
 * @author xy-incito-wy
 * @Decription 认证驳回的用户登录之后，进入修改密码页面，输入正确的当前密码，新密码和确认密码为空，点击提交按钮，不能修改提交成功
 */
public class UserPasswordPage_304_AttestRejectCorrectOldPasswdOthersEmpty_Test extends UserPasswordAttestRejectFather{
	
	@Test(dataProvider="data")
	public void correctOldPasswdOthersEmptyForAttestRejectUser(ITestContext context,Map<String,String> data){
