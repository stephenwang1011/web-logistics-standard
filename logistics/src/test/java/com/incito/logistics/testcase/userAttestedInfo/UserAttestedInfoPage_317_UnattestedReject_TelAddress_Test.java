 ...
 *
 * */
public class UserAttestedInfoPage_317_UnattestedReject_TelAddress_Test extends UserAttestedInfoAttestRejectFather {
	@Test(dataProvider = "data")
	public void userAttestedInfoPageUnattestedRejectTelAddressTest(ITestContext context, Map<String, String> data) {
