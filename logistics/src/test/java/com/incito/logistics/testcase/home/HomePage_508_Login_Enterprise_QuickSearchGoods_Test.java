...
/**
 * @author xy-incito-wk
 * @Description 企业货代账户登录情况下 进行快速查找货源操作，只输入发货地
 * 
 * */
public class HomePage_508_Login_Enterprise_QuickSearchGoods_Test extends BaseParpare {
	@Test(dataProvider="data")
	public void enterPriseFromOnlyQuickSearchGoods(ITestContext context,Map<String,String> data) {
