 ...
 */
public class UserPasswordPage_012_AttestedOldPasswdEmptyOthersNotEmptyDiff_Test extends UserPasswordAttestedFather{
	
	@Test(dataProvider="data")
	public void oldPasswdEmptyOthersNotEmptyDiffForAttestedUser(ITestContext context,Map<String,String> data){
