 ...
 *
 * */
public class UserAttestedInfoPage_307_UnattestedReject_Company_Test extends UserAttestedInfoAttestRejectFather {
	@Test(dataProvider = "data")
	public void userAttestedInfoPageUnattestedRejectCompanyTest(ITestContext context, Map<String, String> data) {
