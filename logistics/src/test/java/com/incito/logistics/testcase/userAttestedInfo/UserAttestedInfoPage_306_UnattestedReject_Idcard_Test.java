 ...
 *
 * */
public class UserAttestedInfoPage_306_UnattestedReject_Idcard_Test extends UserAttestedInfoAttestRejectFather {
	@Test(dataProvider = "data")
	public void userAttestedInfoPageUnattestedRejectIdcardTest(ITestContext context, Map<String, String> data) {
