 ...
 *
 * */
public class UserAttestedInfoPage_321_UnattestedReject_IdcardPhoto_Test extends UserAttestedInfoAttestRejectFather {
	@Test(dataProvider = "data")
	public void userAttestedInfoPageUnattestedRejectIdcardPhotoTest(ITestContext context, Map<String, String> data) {
