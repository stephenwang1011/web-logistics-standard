 ...
 *
 * */
public class UserAttestedInfoPage_341_UnattestedReject_TelIdcardCompanyAddressPhoto_Test extends UserAttestedInfoAttestRejectFather {
	@Test(dataProvider = "data")
	public void userAttestedInfoPageUnattestedRejectTelIdcardCompanyAddressPhotoTest(ITestContext context, Map<String, String> data) {
