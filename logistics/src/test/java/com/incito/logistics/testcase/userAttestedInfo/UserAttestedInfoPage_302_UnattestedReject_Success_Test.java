 ...
 *
 * */
public class UserAttestedInfoPage_302_UnattestedReject_Success_Test extends UserAttestedInfoAttestRejectFather {
	@Test(dataProvider = "data")
	public void userAttestedInfoPageUnattestedRejectSuccessTest(ITestContext context, Map<String, String> data) {
