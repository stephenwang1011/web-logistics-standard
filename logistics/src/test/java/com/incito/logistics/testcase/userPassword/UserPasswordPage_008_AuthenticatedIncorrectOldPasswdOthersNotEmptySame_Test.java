 ...
 */
public class UserPasswordPage_008_AuthenticatedIncorrectOldPasswdOthersNotEmptySame_Test extends UserPasswordFather{
	
	@Test(dataProvider="data")
	public void incorrectOldPasswdOthersNotEmptySameAuthenticatedUser(ITestContext context,Map<String,String> data){
