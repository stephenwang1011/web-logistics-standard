 ...
 */
public class UserPasswordPage_003_AuthenticatedIncorrectOldPasswdOthersEmpty_Test extends UserPasswordFather{
	
	@Test(dataProvider="data")
	public void incorrectOldPasswdOthersEmptyForAuthenticatedUser(ITestContext context,Map<String,String> data){
